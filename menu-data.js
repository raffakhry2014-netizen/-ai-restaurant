...
globalThis.menuItems = [
...

  {
    ...
    allergens: [],
    prep_time: 10,
    tags: ["healthy", "vegan", "protein_rich", "superb_food"],
  },
...

  {
    ...
    spicy_level: 0,
    protein_source: "vegan",
    ingredients: ["Quinoa", "Chickpeas", "Kidney beans", "Avocado", "Vegetables"],
    allergens: [],
    prep_time: 12,
...

  {
    ...
    spicy_level: 0,
    protein_source: "vegetarian",
    ingredients: ["Chocolate cake", "Chocolate center", "Vanilla ice cream"],
    allergens: ["Gluten", "Milk", "Egg"],
    prep_time: 12,
